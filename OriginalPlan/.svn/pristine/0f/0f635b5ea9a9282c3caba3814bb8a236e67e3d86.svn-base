...
work_book = load_excel(ur"vip_thai")
...
vip_erl = "data_vip_thai"
data_vip = module_header(ur"vip配置表", vip_erl, "zm", "vip_thai.xlsx", "data_vip_thai.py")

vip_php = "base_vip_thai.cfg"
data_php_vip = module_php_header(ur"VIP配置", vip_php, "zm", "vip_thai.xlsx", "data_vip_thai.py")
php_vip_base = []
