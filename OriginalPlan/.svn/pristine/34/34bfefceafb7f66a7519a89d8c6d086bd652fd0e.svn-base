#ifndef CPU_TIME_STAT_H
#define CPU_TIME_STAT_H
	...
	*/
	...
	public:
		...
		*/
		...
		static bool		getPIDTicks(uint64& utime, uint64& stime, uint64& cutime, uint64& cstime, uint32 pid);
	...
	private:
		...
		struct CTickStat
		{
			...
			typedef std::deque<std::pair<GXMISC::TTime, float> >	TLoadQueue;
			...
			void	computeLoad(uint32 total, const GXMISC::TTime& ctime)
			{
