...
work_book = load_excel(ur"fun_activity_tw")
...
fun_activity_erl = "data_fun_activity_tw"
data_fun_activity = module_header(ur"精彩活动配置", fun_activity_erl, "zm", "fun_activity_tw.xlsx", "data_fun_activity_tw.py")

act_php = "base_act_tw.cfg"
php_data_act = module_php_header(ur"活动配置", act_php, "zm", "fun_activity_tw.xlsx", "data_fun_activity_tw.py")
