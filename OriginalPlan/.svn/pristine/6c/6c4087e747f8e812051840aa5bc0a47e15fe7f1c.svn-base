...
int ${signature_name}(lua_State* tolua_S)
{
    ...
    #end if
    #end for
    gxError("{0} has wrong number of arguments: {1}, was expecting {2}", "${generator.scriptname_from_native($namespaced_class_name, $namespace_name)}:${func.func_name}",argc, ${func.min_args});
    return 0;
