...
work_book = load_excel(ur"filter_string_tw")
...
filter_erl = "data_filter_tw"
data_filter = module_header(ur"过滤字配置表", filter_erl, "zm", "filter_string_tw.xlsx", "data_filter_tw.py")
data_filter.append("""
