...
excel_file_name = ur'town'

#sheet名及对应导出的lua文件名
sheet2lua_dict = {ur"building_accelerate_item":ur"building_accelerate_item",ur"building_levelup":ur"building_levelup"}
