...
work_book = load_excel(ur"filter_string_thai")
...
filter_erl = "data_filter_thai"
data_filter = module_header(ur"过滤字配置表", filter_erl, "zm", "filter_string_thai.xlsx", "data_filter_thai.py")
data_filter.append("""
