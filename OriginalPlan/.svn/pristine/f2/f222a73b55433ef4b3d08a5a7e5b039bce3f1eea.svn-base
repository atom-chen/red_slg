...
EServerDefine = {
		...
		MAX_TRANS_SIZE = 65526,			----- 地图服务器向世界服务器请求转发的数据的最大长度
...
-- @usage 
EZoneServerState = {
		ZONE_SERVER_STATE_CLOSE = 0,			----- 维护
		ZONE_SERVER_STATE_BUSY = 1,			----- 繁忙
		ZONE_SERVER_STATE_NORMAL = 2,			----- 正常
		ZONE_SERVER_STATE_SPECIAL = 3,			----- 只有GM可以进去
};
-------------------------------------------------------
-- @class enum
...
EPacketIDDef = {
		...
		PACKET_MC_GAME_SERVER_READY = 1105,			----- 服务器准备完成
		...
		PACKET_CM_SELECT_SERVER_MSG = 2003,			----- 选择服务器信息请求
		PACKET_MC_SELECT_SERVER_MSG_RET = 20031,			----- 选择服务器信息返回
		PACKET_CM_LOGIN_lOG_LIST = 2010,			----- 获取该账号登陆过的服务器请求
		PACKET_MC_LOGIN_LOG_LIST_RET = 20101,			----- 获取该账号登陆过的服务器返回
		PACKET_CM_LOGIN_GAME_SERVER = 2011,			----- 登录游戏服务器请求
		PACKET_MC_LOGIN_GAME_SERVER_RET = 20111,			----- 登录游戏服务器返回
