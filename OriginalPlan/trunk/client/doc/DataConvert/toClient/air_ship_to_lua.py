...
excel_file_name = ur'airship'

#sheet名及对应导出的lua文件名
sheet2lua_dict = {
    ur"参数配置":ur"airshipConst",\
    ur"公会飞艇升级配置":ur"air_ship_component_upgrade",\
    ur"飞艇属性类型":ur"air_ship_component_attr",\
    ur"随机对话奖励":ur"air_ship_event",\
    ur"炮弹购买":ur"buy_bomb",\
    ur"队友人数收益系数":ur"air_ship_friend_improve",\
    ur"飞艇护送角色等级":ur"air_ship_lev_need"
    }
