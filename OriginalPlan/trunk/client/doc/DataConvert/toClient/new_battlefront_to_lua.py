...
excel_file_name = ur'newBattlefront'

#sheet名及对应导出的lua文件名
sheet2lua_dict = {ur"城市配置":ur"new_battlefront_country",\
                ur"刺探钻石花费":ur"new_battlefront_spy",\
                ur"CD配置":ur"new_battlefront_cd",\
				ur"功勋翻倍消耗钻石":ur"new_battlefront_double",\
				ur"排行榜奖励":ur"new_battlefront_reward",\
				ur"活动开启时间":ur"new_battlefront_open_time",\
