...
excel_file_name = ur'role_skill'

#sheet名及对应导出的lua文件名
sheet2lua_dict = {ur"战队技能基础配置":ur"role_skill_info",
                    ur"cd清零消耗":ur"role_skill_cd_clear",
                    ur"参数配置":ur"role_skill_sys"
    }
