...
excel_file_name = ur'stone'

#sheet名及对应导出的lua文件名
sheet2lua_dict = {ur"开启等级":ur"rune_open_lv",\
    ur"经验升级":ur"rune_lv",\
	ur"品质转换":ur"rune_quality",\
	ur"经验石品质石金币消耗":ur"rune_cost",\
	ur"购买能量":"rune_energy_cost"
    }
