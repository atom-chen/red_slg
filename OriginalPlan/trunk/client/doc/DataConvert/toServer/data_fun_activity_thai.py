...
work_book = load_excel(ur"fun_activity_thai")
...
fun_activity_erl = "data_fun_activity_thai"
data_fun_activity = module_header(ur"精彩活动配置", fun_activity_erl, "zm", "fun_activity_thai.xlsx", "data_fun_activity_thai.py")

act_php = "base_act_thai.cfg"
php_data_act = module_php_header(ur"活动配置", act_php, "zm", "fun_activity_thai.xlsx", "data_fun_activity_thai.py")
