...
work_book = load_excel(ur"commanderRank")
...
power_vip_erl = "data_power_vip"
data_power_vip = module_header(ur"军阶配置表", power_vip_erl, "zm", "commanderRank.xlsx", "data_power_vip.py")
