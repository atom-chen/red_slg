...
work_book = load_excel(ur"commanderRank_tw")
...
power_vip_erl = "data_power_vip_tw"
data_power_vip = module_header(ur"军阶配置表", power_vip_erl, "zm", "commanderRank_tw.xlsx", "data_power_vip_tw.py")
