...
work_book = load_excel(ur"rechargeEveryDay")
...
recharge_everyday_erl = "data_recharge_everyday"
data_recharge_everyday = module_header(ur"每日充值配置", recharge_everyday_erl, "zm", "rechargeEveryDay.xlsx", "data_recharge_everyday.py")
