...
work_book = load_excel(ur"rechargeEveryDay_tw")
...
recharge_everyday_erl = "data_recharge_everyday_tw"
data_recharge_everyday = module_header(ur"每日充值配置", recharge_everyday_erl, "zm", "rechargeEveryDay_tw.xlsx", "data_recharge_everyday_tw.py")
