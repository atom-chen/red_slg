...
work_book = load_excel(ur"upVerSendGold_tw")
...
up_ver_send_gold_erl = "data_up_ver_send_gold_tw"
data_up_ver_send_gold = module_header(ur"更新版本配置", up_ver_send_gold_erl, "zm", "new_chest.xlsx", "data_up_ver_send_gold.py")
