...
int ${signature_name}(lua_State* tolua_S)
{
    ...
    gxError("${generator.scriptname_from_native($namespaced_class_name, $namespace_name)}:${func.func_name} has wrong number of arguments: {0}, was expecting {1}",argc, ${func.min_args});
    return 0;
