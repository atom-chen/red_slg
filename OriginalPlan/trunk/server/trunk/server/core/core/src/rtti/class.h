...
public:
	...
	bool newInstance(__RT*& retobj)
	{
		...
		{
			char szbuff[512];
			gxDebug("找不到与函数原型 {0} 匹配的构造函数!", RTTIFuncTypeGetDis((stInvokeCallHelper<int, __RT>::new0)NULL, szbuff, this, "new0"));
		}
	...
	bool newInstance(__RT*& retobj, __P1 p1)
	{
		...
		{
			char szbuff[512];
			gxDebug("找不到与函数原型 {0} 匹配的构造函数!", RTTIFuncTypeGetDis((stInvokeCallHelper<int, __RT, __P1>::new1)NULL, szbuff, this, "new1"));
		}
	...
	bool newInstance(__RT*& retobj, __P1 p1, __P2 p2)
	{
		...
		{
			char szbuff[512];
			gxDebug("找不到与函数原型 {0} 匹配的构造函数!", RTTIFuncTypeGetDis((stInvokeCallHelper<int, __RT, __P1, __P2>::new2)NULL, szbuff, this, "new2"));
		}
	...
	bool newInstance(__RT*& retobj, __P1 p1, __P2 p2, __P3 p3)
	{
		...
		{
			char szbuff[512];
			gxDebug("找不到与函数原型 {0} 匹配的构造函数!", RTTIFuncTypeGetDis((stInvokeCallHelper<int, __RT, __P1, __P2, __P3>::new3)NULL, szbuff, this, "new3"));
		}
	...
	bool newInstance(__RT*& retobj, __P1 p1, __P2 p2, __P3 p3, __P4 p4)
	{
		...
		{
			char szbuff[512];
			gxDebug("找不到与函数原型 {0} 匹配的构造函数!", RTTIFuncTypeGetDis((stInvokeCallHelper<int, __RT, __P1, __P2, __P3, __P4>::new4)NULL, szbuff, this, "new4"));
		}
