...
namespace GXMISC
{
    ...
    //
    //////////////////////////////////////////////////////////////////////
    TSocket_t SOCKET_API::gx_socket ( sint32 domain , sint32 type , sint32 protocol ) 
    {
        TSocket_t s = ::socket(domain,type,protocol);
        ...
        if ( s == INVALID_SOCKET ) 
        {
            ...
            default : 
                {
					gxCondLogB(_g_LibConfig.isConfig(LIB_CONFIG_DBG_SOCK_ERR), "Socket error!{0}", errno);
                    break;
                }
            }   
    ...
    //
    //////////////////////////////////////////////////////////////////////
    bool SOCKET_API::gx_bind ( TSocket_t s , const struct sockaddr * addr , sint32 addrlen ) 
    {
    ...
    //
    //////////////////////////////////////////////////////////////////////
    bool SOCKET_API::gx_connect ( TSocket_t s , const struct sockaddr * addr , sint32 addrlen )
    {
    ...
    bool SOCKET_API::gx_connect2( TSocket_t sockfd, const struct sockaddr* addr, sint32 addrlen, sint32 timeout )
    { 
        sint32 fd_num = 0;   
        ...
        {    
            gxError("set noblocking! errno = {0}", gx_socket_errno);
            return false;   
        }
        ...
        {   
            ...
            {      
                ...
                {   
                    ...
                    gxError( "select failed! errno = {0}", gx_socket_errno);     
                    return false;
                }   
                else if(0 == fd_num)   
                {   
                ...
                {
                    gx_setsocketnonblocking(sockfd, false);
                    gxError("get connect socket opt error: {0}, ret={1}", gx_socket_errno, ret);
                    return false;
                }
                ...
                {
                    gx_setsocketnonblocking(sockfd, false);
                    gxError("connect socket error: {0}, ret={1}", gx_socket_errno, ret);
                    return false;
                }
    ...
    //
    //////////////////////////////////////////////////////////////////////
    bool SOCKET_API::gx_listen ( TSocket_t s , sint32 backlog ) 
    {
    ...
    //
    //////////////////////////////////////////////////////////////////////
    TSocket_t SOCKET_API::gx_accept ( TSocket_t s , struct sockaddr * addr , uint32 * addrlen )
    {
#ifdef OS_UNIX
        TSocket_t client = accept( s , addr , (socklen_t*) addrlen );
#elif defined( OS_WINDOWS )
        TSocket_t client = accept( s , addr , (int*)addrlen );
#endif
    ...
    //
    //////////////////////////////////////////////////////////////////////
    bool SOCKET_API::gx_getsockopt ( TSocket_t s , sint32 level , sint32 optname , void * optval , uint32 * optlen )
    {
#ifdef OS_UNIX
    ...
    sint32 SOCKET_API::gx_getsockopt2 ( TSocket_t s , sint32 level , sint32 optname , void * optval , uint32 * optlen )
    {
#ifdef OS_UNIX
        if ( getsockopt( s , level , optname , optval , (socklen_t*)optlen ) == SOCKET_ERROR ) 
        {
    ...
    //
    //////////////////////////////////////////////////////////////////////
    bool SOCKET_API::gx_setsockopt ( TSocket_t s , sint32 level , sint32 optname , const void * optval , sint32 optlen )
    {
#ifdef OS_UNIX
    ...
    // 
    //////////////////////////////////////////////////////////////////////
    sint32 SOCKET_API::gx_send ( TSocket_t s , const void * buf , sint32 len , sint32 flags )
    {
        sint32 nSent = 0;
#ifdef OS_UNIX
...
//			case EAGAIN :
    ...
    sint32 SOCKET_API::gx_sendto ( TSocket_t s , const void * buf , sint32 len , sint32 flags , const struct sockaddr * to , sint32 tolen )
    {
#ifdef OS_UNIX
...
//			case EAGAIN :
    ...
    //
    //////////////////////////////////////////////////////////////////////
    sint32 SOCKET_API::gx_recv ( TSocket_t s , void * buf , sint32 len , sint32 flags )
    {
#ifdef OS_UNIX
...
//			case EAGAIN:
    ...
    sint32 SOCKET_API::gx_recvfrom ( TSocket_t s , void * buf , sint32 len , sint32 flags , struct sockaddr * from , uint32 * fromlen )
    {
#ifdef OS_UNIX
...
//			case EAGAIN :
    ...
    //
    /////////////////////////////////////////////////////////////////////
    bool SOCKET_API::gx_closesocket ( TSocket_t s )
    {
		gx_shutdown(s, 0x02);
#ifdef OS_UNIX
        close(s);
    ...
    bool SOCKET_API::gx_ioctlsocket ( TSocket_t s , long cmd , unsigned long * argp )
    {
#ifdef OS_UNIX
#elif defined( OS_WINDOWS )
    ...
    //
    //////////////////////////////////////////////////////////////////////
    bool SOCKET_API::gx_getsocketnonblocking ( TSocket_t s )
    {
#ifdef OS_UNIX
    ...
    //
    //////////////////////////////////////////////////////////////////////
    bool SOCKET_API::gx_setsocketnonblocking ( TSocket_t s , bool on )
    {
#ifdef OS_UNIX
        sint32 flags = FILE_API::gx_fcntl( s , F_GETFL , 0 );
        if ( on )
    ...
    //
    //////////////////////////////////////////////////////////////////////
    sint32 SOCKET_API::gx_availablesocket ( TSocket_t s )
    {
#ifdef OS_UNIX
    ...
    //
    //////////////////////////////////////////////////////////////////////
    bool SOCKET_API::gx_shutdown ( TSocket_t s , sint32 how )
    {
        if ( shutdown(s,how) < 0 ) 
        {
#ifdef OS_UNIX
    ...
    sint32 SOCKET_API::gx_select ( TSocket_t maxfdp1 , fd_set * readset , fd_set * writeset , fd_set * exceptset , TTimeVal_t * timeout )
    {
